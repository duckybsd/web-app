...
//     signature = Crypto.util.hexToBytes('3044022070B697B04360D39CC09BD891F8D8ABF893DD6C20F6EAA93076FFCF45EB701F320220639E62BA2FE89D2BA2657CCCC45F2D6C07C492E75E478220E643EAC1654E72BF');
    ...
    var testSeqR = [];
    testSeqR = testSeqR.concat(obj.r.toByteArrayUnsigned());
    console.log("r: " + Crypto.util.bytesToHex(testSeqR));
    var testSeqS = [];
    testSeqS = testSeqS.concat(obj.s.toByteArrayUnsigned());
    console.log("s: " + Crypto.util.bytesToHex(testSeqS));
    ...
    for (var i = 0; i < 4; i++) {
        ...
        if (compressed)
            ...
            nV += 4;
        sequence[0] = nV;
            console.log("sequence iterated: " + Crypto.util.bytesToHex(sequence));
